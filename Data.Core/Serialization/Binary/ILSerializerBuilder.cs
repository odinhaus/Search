...
{
    public class ILSerializerBuilder : Altus.Suffūz.Serialization.Binary.IBinarySerializerBuilder, IComparer<MemberInfo>
    {
        ...
        public ISerializer CreateSerializerType(Type type)
        {
            ...
            var generatedSerializer = type.GetCustomAttribute(typeof(Altus.Suffūz.Serialization.Binary.GeneratedSerializerAttribute));
            if (generatedSerializer != null)
            {
                type = ((Altus.Suffūz.Serialization.Binary.GeneratedSerializerAttribute)generatedSerializer).WrappedType;
            }

            if (Altus.Suffūz.Serialization.Binary.PrimitiveSerializer.IsPrimitive(type))
            {
                return new Altus.Suffūz.Serialization.Binary.PrimitiveSerializer();
            }
            else if (Altus.Suffūz.Serialization.Binary.IDictionarySerializer.IsDictionaryType(type))
            {
                return new Altus.Suffūz.Serialization.Binary.IDictionarySerializer();
            }
            else if (Altus.Suffūz.Serialization.Binary.IListSerializer.IsListType(type))
            {
                return new Altus.Suffūz.Serialization.Binary.IListSerializer();
            }
            else if (Altus.Suffūz.Serialization.Binary.IEnumerableSerializer.IsIEnumerableType(type))
            {
                return new Altus.Suffūz.Serialization.Binary.IEnumerableSerializer();
            }
            else if (type == typeof(object))
            {
                return new Altus.Suffūz.Serialization.Binary.ObjectSerializer();
            }
            else if (Altus.Suffūz.Observables.Serialization.Binary.ObservableSerializer.IsObservable(type))
            {
                return new Altus.Suffūz.Observables.Serialization.Binary.ObservableSerializer(this);
            }
        ...
        private Type ImplementSerializerType(Type type)
        {
            ...
            var attribCtor = typeof(Altus.Suffūz.Serialization.Binary.GeneratedSerializerAttribute).GetConstructors()[0]; // there's only one
        ...
        private IEnumerable<MemberInfo> GetSerializableMembers(Type type)
        {
            return type.GetMembers(BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Instance)
                       ...
                       && mi.GetCustomAttribute<Altus.Suffūz.Serialization.Binary.BinarySerializableAttribute>() != null);
        }

        public int Compare(MemberInfo x, MemberInfo y)
        {
            var xA = ((Altus.Suffūz.Serialization.Binary.BinarySerializableAttribute[])x.GetCustomAttributes(typeof(Altus.Suffūz.Serialization.Binary.BinarySerializableAttribute), true))[0];
            var yA = ((Altus.Suffūz.Serialization.Binary.BinarySerializableAttribute[])y.GetCustomAttributes(typeof(Altus.Suffūz.Serialization.Binary.BinarySerializableAttribute), true))[0];

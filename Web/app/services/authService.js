...
app.factory('authService', ['$http', '$q', 'localStorageService', 'ngAuthSettings', function ($http, $q, localStorageService, ngAuthSettings) {
    ...
    var _customerRegistration = function(registration) {
        return $http.post(serviceBase + 'api/account/customer/register', registration).then(function(response) {
            return response;
        });
    }
    ...
    var _login = function (loginData) {
        ...
        var data = "grant_type=password"
            ...
            + "&client_secret=" + ngAuthSettings.clientSecret
            + "&device_id=" + ngAuthSettings.deviceId;
